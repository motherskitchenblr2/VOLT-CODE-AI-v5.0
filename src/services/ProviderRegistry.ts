      ...
      models: [
        {
          ...
          tokenCostPerMillionInput: 0.59,
          tokenCostPerMillionOutput: 0.79,
        ...
        },
        {
          ...
          name: "Llama 3.1 8B",
          contextWindow: 128000,
          tokenCostPerMillionInput: 0.05,
          tokenCostPerMillionOutput: 0.08,
          capabilities: { streaming: true, vision: false, toolCalling: true },
        },
        {
          ...
          contextWindow: 128000,
          tokenCostPerMillionInput: 0.7,
          tokenCostPerMillionOutput: 0.9,
      ...
      models: [
        {
          ...
          contextWindow: 32000,
          tokenCostPerMillionInput: 0.07,
          tokenCostPerMillionOutput: 0.07,
          capabilities: { streaming: true, vision: false, toolCalling: true },
        },
        {
          ...
          tokenCostPerMillionInput: 2.5,
          tokenCostPerMillionOutput: 2.5,
          capabilities: { streaming: true, vision: false, toolCalling: false },
        },
      ],
    });
      ...
      models: [
        {
          ...
          tokenCostPerMillionInput: 0.0,
          tokenCostPerMillionOutput: 0.0,
          capabilities: { streaming: true, vision: false, toolCalling: false },
        },
      ],
    });
