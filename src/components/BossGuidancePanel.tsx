  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Header */}
        <div
          className={`p-4 bg-gradient-to-r ${getRiskColor(guidance.riskLevel)} text-white`}
        >
        ...
        <div className="p-4 space-y-4 overflow-y-auto max-h-80">
          ...
          {/* Risk Assessment */}
          <div
            className={`p-3 rounded-lg border ${getRiskBadgeColor(guidance.riskLevel)}`}
          >
